...
const LoginPage = () => {
  return (
    <div className="h-screen w-screen bg-gray-900 flex justify-center items-center p-4">
      <div className="flex flex-col md:flex-row bg-black rounded-lg shadow-lg overflow-hidden max-w-4xl w-full">
        {/* Left Section */}
